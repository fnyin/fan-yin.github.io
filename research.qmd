...
*with Gabriel Ahlfeldt, Stephan Heblich and Tobias Seidel*

:::: {layout="[[1,1]]"}
::: {}
![Commercial rent index for Berlin in 2024. Red solid lines are the prime locations (CBD).](papers/price_of_prodoctivity/MAP_AHS_com_Berlin_2024.png){fig-alt="Commercial rent index for Berlin in 2024" width="80%"}
:::
...
👉 Read the full and most recent [[Draft]](https://github.com/Ahlfeldt/DPs/blob/main/GA_SH_TS_FY_-_Productivity.pdf){target="_blank"}.

👉 Or the [[BSoE Insight Piece]](https://berlinschoolofeconomics.de/insight/the-price-of-productivity){target="_blank"} for a short (and fun) read.
